...
Public Class regulaCustomers
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Yes_Please_.regulaCustomers.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedregulaCustomers
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As regulaCustomers = New regulaCustomers()
        rpt.Site = Me.Site
        Return rpt
    End Function
